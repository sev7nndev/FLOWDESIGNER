...
export const api = {
  generate: async (businessInfo: BusinessInfo): Promise<GeneratedImage> => {
    ...
    try {
      ...
      // Apenas consome o corpo da resposta para garantir que a conexão seja fechada
      await response.json(); 
      ...
      const supabaseAnonClient = getSupabase(); // Buscamos o registro mais recente que corresponde à URL gerada
