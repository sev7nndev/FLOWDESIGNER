...
export const StyleCard: React.FC<StyleCardProps> = ({ style, isSelected, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`group relative overflow-hidden p-4 rounded-xl border transition-all duration-300 text-left w-full h-24 flex flex-col justify-between ${isSelected
