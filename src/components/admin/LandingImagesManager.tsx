...
import { Upload, Trash2, Loader2, CheckCircle2, Image as ImageIcon, AlertTriangle } from 'lucide-react';
...
const ImageUpload: React.FC<ImageUploadProps> = ({ onUpload }) => {
    ...
    const handleUpload = useCallback(async () => {
        ...
        try {
            ...
            setFile(null);
            if (document.getElementById('file-upload-landing')) {
                (document.getElementById('file-upload-landing') as HTMLInputElement).value = '';
            }
        } catch (e: any) {
...
export const LandingImagesManager: React.FC<{ user: User }> = ({ user }) => {
    ...
    return (
        <div className="space-y-4 bg-zinc-900/50 p-6 rounded-xl border border-white/10">
            ...
            <ImageUpload onUpload={handleUploadWrapper} />
