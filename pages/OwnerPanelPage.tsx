            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="flex items-center justify-between border-b border-primary/50 pb-4 mb-8">
                    <h1 className="text-3xl font-extrabold text-white flex items-center gap-3">
                        <DollarSign size={28} className="text-primary" /> Painel do Dono do SaaS
                    </h1>
                ...
                <div className="flex border-b border-white/10 mb-8">
                    <button 
                        ...
                        className={`px-6 py-3 text-sm font-medium transition-colors ${activeTab === 'dashboard' ? 'text-primary border-b-2 border-primary' : 'text-gray-400 hover:text-white'}`}
                    >
                        Dashboard
                    </button>
                    <button 
                        onClick={() => setActiveTab('clients')}
                        className={`px-6 py-3 text-sm font-medium transition-colors ${activeTab === 'clients' ? 'text-primary border-b-2 border-primary' : 'text-gray-400 hover:text-white'}`}
                    >
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="pt-8">
                            <Button onClick={refreshMetrics} variant="secondary" className="text-sm">
                                <Loader2 size={16} className="mr-2" /> Atualizar Dados
                            </Button>
                        </div>
                    </div>
                )}
